...
/** Satellite + street labels — reads as real terrain when combined with 3D pitch. */
export const MAP_STYLE =
  process.env.NEXT_PUBLIC_MAP_STYLE ?? "mapbox://styles/mapbox/satellite-streets-v12";
...
/** Adds elevation mesh + extruded buildings (call after style loads). */
